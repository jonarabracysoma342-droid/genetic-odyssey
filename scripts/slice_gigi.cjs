...
const inputPath = 'C:/Users/ADVAN/.gemini/antigravity-ide/brain/4266137e-7a8a-4970-86bc-f00ce079a0ad/.user_uploaded/media_1789133238429.jpg';
const outDir = path.resolve('public/assets/rpg/npc/mechanic');

if (!fs.existsSync(outDir)) {
  fs.mkdirSync(outDir, { recursive: true });
}

async function sliceGigi() {
  // 1. Save full sprite sheet backup
  await sharp(inputPath).jpeg({ quality: 92 }).toFile('public/assets/rpg/npc/gigi_mechanic_spritesheet.jpg');
  console.log('Saved gigi_mechanic_spritesheet.jpg');
  ...
  const slices = [
    ...
    { name: 'wipe_0',    x: 1 * 256, y: 357, w: 256, h: 202 },
    { name: 'wrench_0',  x: 2 * 256, y: 357, w: 256, h: 202 },
    { name: 'goggles_0', x: 3 * 256, y: 357, w: 256, h: 202 },
  ];
