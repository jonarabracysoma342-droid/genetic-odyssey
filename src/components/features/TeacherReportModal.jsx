        ...
        {activeTab === 'identity' && (
          <div className="space-y-4 py-1 animate-fade-in">
            <div className="flex items-center gap-2">
              ...
              <h4 className="font-extrabold text-sm text-black">Identitas Modul Ajar (Kurikulum Merdeka)</h4>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-3xl bg-slate-50/50 border border-slate-100 flex items-center gap-4 hover:shadow-xs transition duration-300">
                ...
                <div className="space-y-0.5 text-left">
                  <span className="text-[10px] font-bold text-black/60 uppercase tracking-wider block">MATA PELAJARAN</span>
                  <p className="text-black font-extrabold text-sm">Biologi (Pewarisan Sifat)</p>
                </div>
              </div>
              ...
              <div className="p-4 rounded-3xl bg-slate-50/50 border border-slate-100 flex items-center gap-4 hover:shadow-xs transition duration-300">
                ...
                <div className="space-y-0.5 text-left">
                  <span className="text-[10px] font-bold text-black/60 uppercase tracking-wider block">JUDUL MODUL APPS</span>
              ...
              {/* Card 5: Sarana Prasarana (Full Width) */}
              <div className="p-4 rounded-3xl bg-slate-50/50 border border-slate-100 flex items-center gap-4 hover:shadow-xs transition duration-300 col-span-1 md:col-span-2">
                ...
                <div className="space-y-0.5 text-left">
                  <span className="text-[10px] font-bold text-black/60 uppercase tracking-wider block">SARANA & PRASARANA MEDIA</span>
                  <p className="text-black font-bold text-xs sm:text-sm">Perangkat HP/Tablet/Laptop, Koneksi Internet, Proyektor LCD (untuk guru)</p>
                </div>
              </div>
          ...
          <div className="space-y-5 py-1 animate-fade-in">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-extrabold text-sm text-black">Tujuan Pembelajaran (TP) Modul</h4>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
                  ...
                  <div 
                    key={idx} 
                    className={`p-4 rounded-2xl border border-slate-100 flex gap-3 hover:shadow-xs transition duration-300 bg-white ${
                      idx === 4 ? 'col-span-1 md:col-span-2' : ''
                    }`}
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-5 rounded-3xl bg-gradient-to-b from-emerald-50/50 to-white border border-emerald-100/70 shadow-2xs hover:shadow-xs hover:border-emerald-200 transition duration-300 flex flex-col items-center text-center space-y-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-[10px] sm:text-[11px] text-black leading-relaxed font-bold">
                    Siswa menguji pemahaman secara mandiri dengan menyelesaikan 8 stage level permainan, memantau kemajuan, dan melatih konsep di Virtual Lab.
                  </p>
                </div>
              </div>
              ...
              <div className="p-5 rounded-3xl bg-gradient-to-b from-amber-50/50 to-white border border-amber-100/70 shadow-2xs hover:shadow-xs hover:border-amber-200 transition duration-300 flex flex-col items-center text-center space-y-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-[10px] sm:text-[11px] text-black leading-relaxed font-bold">
                    Siswa secara mandiri merancang kombinasi genotipe parental (P1 & P2) di Virtual Lab untuk mensimulasikan hasil anakan F1/F2 secara kreatif.
                  </p>
                </div>
              </div>
